...
My contribution to Daniel Huffman's [Projection Collection](https://somethingaboutmaps.wordpress.com/2022/06/07/projection-cards-now-a-reality/) project, a set of trading cards where each card is a different map projection.
